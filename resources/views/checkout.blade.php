        ...
        <div class="col-lg-10">
            <div class="glass-card p-4 p-md-5 mt-5 animate-fade-in">
                <div class="checkout-header text-center">
                    <p class="text-accent small text-uppercase fw-bold mb-2" style="letter-spacing: 3px;">Final Acquisition</p>
                ...
                <form id="payment-form" method="POST" action="{{ route('checkout.process') }}">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-7">
                            <h5 class="text-bright mb-4 fs-6 fw-bold text-uppercase" style="letter-spacing: 1px;">Shipping Orchestration</h5>
                            
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="name" class="premium-label">Full Identity</label>
                                    <input type="text" id="name" name="name" class="form-control premium-input" placeholder="e.g. Alexander Sterling" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label for="email" class="premium-label">Email Coordinate</label>
                                    <input type="email" id="email" name="email" class="form-control premium-input" placeholder="alexander@sterling.com" required>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="phone" class="premium-label">Direct Line</label>
                                <input type="tel" id="phone" name="phone" class="form-control premium-input" placeholder="+1 (555) LUX-0000" required>
                            </div>

                            <div class="mb-5">
                                <label for="address" class="premium-label">Delivery Destination</label>
                                <textarea id="address" name="address" class="form-control premium-input" rows="3" placeholder="Enter full shipping residence details" required></textarea>
                            </div>
                        </div>

                        <div class="col-lg-5">
                            <div class="order-summary-mini mb-5">
                                <h5 class="text-bright mb-4 fs-6 fw-bold text-uppercase" style="letter-spacing: 1px;">Strategic Summary</h5>
                                ...
                                <div class="d-flex justify-content-between border-top border-silver-dim pt-3">
                                    <span class="text-silver-dim">Investment Total</span>
                                    <span class="text-accent fw-bold fs-5" id="summary-total">$0.00</span>
                                </div>
                            </div>

                            <h5 class="text-bright mb-4 fs-6 fw-bold text-uppercase" style="letter-spacing: 1px;">Transaction Method</h5>
                            
                            <div class="d-flex flex-column gap-3 mb-4">
                                <div class="form-check custom-radio d-flex align-items-center">
                                    <input class="form-check-input me-3" type="radio" name="payment_method" id="payment_card" value="card" checked>
                                    <label class="form-check-label text-silver mb-0" for="payment_card">
                                        <i class="fas fa-credit-card me-2 opacity-50"></i> Credit/Debit Card
                                    </label>
                                </div>
                                <div class="form-check custom-radio d-flex align-items-center">
                                    <input class="form-check-input me-3" type="radio" name="payment_method" id="payment_cod" value="cod">
                                    <label class="form-check-label text-silver mb-0" for="payment_cod">
                                        <i class="fas fa-truck me-2 opacity-50"></i> Cash on Delivery
                                    </label>
                                </div>
                            </div>
                            ...
                            <div id="card-element-container" class="mb-4 fade-in">
                                <label for="card-element" class="premium-label">Encryption Details</label>
                            ...
                            <div class="mt-4">
                                <button id="submitBtn" class="btn btn-primary-custom w-100 py-3 shadow-accent-glow" type="submit">
