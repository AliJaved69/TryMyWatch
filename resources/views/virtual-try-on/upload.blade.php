...
@section('content')
    ...
    <section class="py-5 bg-onyx min-vh-100" style="margin-top: 80px;">
        <div class="container text-center">
            ...
            <p class="lead text-secondary mb-5">Fit the <strong>{{ $product->title }}</strong> to your wrist using AI
                analysis.</p>
                    ...
                    <div class="glass-card p-5">
                        ...
                        <div id="camera-container" class="d-none mb-4">
                            <div class="camera-wrapper glass-card overflow-hidden">
                                <video id="webcam" autoplay playsinline class="w-100"
                                    style="max-height: 350px; object-fit: cover;"></video>
                                <canvas id="photo-canvas" class="d-none"></canvas>
                                <div class="camera-controls p-3 bg-dark">
                                    <button type="button" id="capture-btn"
                                        class="btn btn-accent rounded-circle p-3 shadow-accent-glow">
                            ...
                            <div id="preview-container" class="d-none mt-3">
                                ...
                                <img id="photo-preview" class="img-fluid rounded border border-accent mb-3"
                                    style="max-height: 200px;">
                                <div class="d-flex justify-content-center gap-2">
                                    <button type="button" id="retake-btn"
                                        class="btn btn-outline-danger px-4">Retake</button>
                                    <button type="button" id="confirm-capture-btn" class="btn btn-primary-custom px-4">Use
                                        Photo</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="glass-card p-3 d-flex justify-content-center align-items-center position-relative">
                        <div class="tryon-editor-viewport" id="tryon-viewport"
                            ...
                            <div class="draggable-watch-wrapper" id="watch-draggable"
                                style="pointer-events: none; touch-action: none; cursor: default;">
                                <img src="{{ $product->thumbnail }}" id="active-watch-img" class="draggable-watch-img"
                                    alt="Watch Overlay" crossorigin="anonymous">
                            </div>
                        </div>

                        <div id="loading"
                            class="position-absolute top-50 start-50 translate-middle text-warning text-center p-4 rounded glass-card border border-accent"
                            style="z-index: 20; background: rgba(11, 12, 16, 0.9);">
                    ...
                    <div class="glass-card p-5 h-100 d-flex flex-column justify-content-between text-start">
                        <div>
                            ...
                            <div class="alert alert-dark border-silver-dim py-3" style="background: rgba(31, 40, 51, 0.3);">
                                <p class="text-silver small mb-0"><i class="fas fa-info-circle text-accent me-2"></i>The
                                    watch has been automatically fitted to your wrist using AI analysis. Download the result
                                    below.</p>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <a href="{{ route('product.show', $product->id) }}"
                                class="btn btn-outline-light py-2 mt-2 text-center">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function onResults(results) {
                ...
                if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
                    ...
                    const targetWatchWidth = handWidth * 2.25;
